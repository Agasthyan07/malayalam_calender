...
export default function PrivacyPolicy() {
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            <h1 className="text-3xl md:text-4xl font-bold mb-8 text-gray-900 dark:text-gray-100">Privacy Policy</h1>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 md:p-8 shadow-sm border border-gray-100 dark:border-gray-700 prose prose-lg dark:prose-invert max-w-none text-gray-700 dark:text-gray-300">
                <p className="lead text-xl text-gray-600 dark:text-gray-400 mb-8 border-l-4 border-red-600 pl-4 py-1">
                    Your privacy is critically important to us. This policy details how Malayalam Calendar collects, uses, and protects your data.
                </p>
                ...
                <p>
                    ...
                    This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Malayalam Calendar.
                </p>

                <h2>2. Information We Collect</h2>
                <p>
                    We prioritize data minimization. The personal information that you are asked to provide, and the reasons why you are asked to provide it, will be made clear to you at the point we ask you to provide your personal information.
                </p>
                <ul>
                    <li><strong>Directly Provided Data:</strong> If you contact us directly (e.g., via email or contact forms), we may receive additional information such as your name, email address, phone number, the contents of the message and/or attachments you may send us, and any other information you may choose to provide.</li>
                    <li><strong>Log Files:</strong> Malayalam Calendar follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this as a part of hosting services' analytics. The information collected by log files includes internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website, and gathering demographic information.</li>
                </ul>
                ...
                <ul>
                    ...
                    <li>Improve, personalize, and expand our website (e.g., remembering your preferred calendar view)</li>
                    <li>Understand and analyze how you use our website to optimize performance</li>
                ...
                <p>
                    Like any other website, Malayalam Calendar uses 'cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited.
                ...
                <p>
                    You may consult this list to find the Privacy Policy for each of the advertising partners of Malayalam Calendar.
                    Third-party ad servers or ad networks use technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on Malayalam Calendar, which are sent directly to users' browser.
                ...
                <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg border-l-4 border-yellow-400 mb-6">
                    <p className="text-sm m-0"><strong>Note:</strong> Malayalam Calendar has no access to or control over these cookies that are used by third-party advertisers.</p>
                </div>

                <h2>7. Third Party Privacy Policies</h2>
                <p>
                    Malayalam Calendar's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information.
                ...
                <p>
                    Malayalam Calendar does not knowingly collect any Personal Identifiable Information from children under the age of 13.
                ...
                <p className="font-medium text-center">
                    If you have any questions about this Privacy Policy, please contact us at <a href="mailto:agasthyan2002@gmail.com" className="text-red-600 hover:text-red-700 underline">agasthyan2002@gmail.com</a>.
                </p>
            </div>
        </div>
    );
