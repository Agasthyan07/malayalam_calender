        ...
        <div className="container mx-auto px-4 py-8 max-w-3xl">
            ...
            <div className="mt-10 pt-6 border-t border-gray-100 dark:border-gray-800 text-center">
                <p className="text-gray-600 dark:text-gray-400">
                    Check other major festivals: <Link prefetch={false} href="/onam-2026-date" className="text-indigo-600 font-medium hover:underline">Onam 2026</Link> • <Link prefetch={false} href="/festivals" className="text-indigo-600 font-medium hover:underline">All Festivals</Link>
                </p>
            </div>
        </div>
    );
