            ...
            <nav className="flex text-sm text-gray-500 mb-4 overflow-x-auto whitespace-nowrap" aria-label="Breadcrumb">
                <ol className="inline-flex items-center space-x-1 md:space-x-3">
                    <li className="inline-flex items-center">
                        <Link prefetch={false} href="/" className="inline-flex items-center hover:text-gray-900 dark:hover:text-white transition-colors">
                        ...
                        <li key={item.href}>
                            <div className="flex items-center">
                                ...
                                {index === items.length - 1 ? (
                                    ...
                                    <Link prefetch={false} href={item.href} className="ml-1 hover:text-gray-900 dark:hover:text-white md:ml-2 transition-colors">
                                        {item.label}
                                    </Link>
                                )}
                            </div>
